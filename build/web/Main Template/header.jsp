                                ...
                                <c:choose>
                                        ...
                                        <div class="main-menu">
                                            <nav class="navigation">
                                                <ul class="nav menu">
                                                    ...
                                                    <li><a href="${pageContext.request.contextPath}/Main%20Template/support.jsp">AI Support</a></li>
                                                </ul>
                                            </nav>
                                        </div>
                                        <!--/ End Main Menu -->
                                    ...
                                    <c:when test="${not empty sessionScope.user and sessionScope.user.role eq 'Professor'}">
                                        ...
                                        <div class="main-menu">
                                            <nav class="navigation">
                                                <ul class="nav menu">
                                                    <li><a href="${pageContext.request.contextPath}/timeTableRegistration">Time table </a></li>

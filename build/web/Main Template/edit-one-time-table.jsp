                            ...
                            <div class="doctor-calendar-table table-responsive">
                                <table class="table">
                                    ...
                                    <form action="TimeSessionServlet" method="GET">
                                        ...
                                        <input type="hidden" name="timeSessionId" value="${timeSession.timeSessionId}"/>



                                        <input type="hidden" class="form-control" name="userId" value="${timeSession.user.userId}" />

                                        <td>
                                            ${timeSession.user.name}
                                        </td>



                                        <td>
                                            ${timeSession.day.dayOfWeekName}
                                        ...
                                        <td>
                                            <select name="dayOfWeekId" class="form-control">
                                                <c:forEach items="${dayOfWeeksUpdate}" var="day">
                                                    <option value="${day.getDayOfWeekId()}">${day.getDayOfWeekName()}</option>
                                                </c:forEach>
                                            </select>
                                        </td>
                                        <td>
                                            <select name="timeManagementId" class="form-control">
                                                <c:forEach items="${timeManagementsUpdate}" var="timeManagement">
